...
class OptimizationParams(ParamGroup):
    def __init__(self, parser):
        ...
        self.metallic_loss_until_iter = 120000
        ...
        self.num_emitters = 20             # --num_emitters
        self.emitter_lr = 5e-3            # --emitter_lr
        self.emitters_from_iter = 3000    # --emitters_from_iter (optional)
        
        
        self.lambda_emit_sparsity   = 0.0   # emitter gain L1
        self.lambda_emit_gate_cons  = 0.0   # gate consistency
        self.lambda_emit_residual   = 0.0   # residual fit
